            ...
            if (filterState) {
                this.state.filterList.map(function (filterItem, index) {
                    if (filterItem.visible) {
                        filterListItemHtml.push(_react2.default.createElement(_filterListItem2.default, { filterClicked: _this2._filterUpdated, index: index, label: filterItem.display, selected: filterItem.selected }));
                    }
                });
